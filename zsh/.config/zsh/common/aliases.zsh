...
alias la='eza -la --icons --git --group-directories-first'alias lt='eza -T --icons --git-ignore --group-directories-first'     # tree view
...
alias trees="eza --tree --icons --git --ignore-glob='__pycache__' --ignore-glob='*.pyc'"
alias mkdir='mkdir -p'
alias rd='rmdir'
